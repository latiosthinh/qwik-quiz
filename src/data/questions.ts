...
metaClass.RemoveField("BidPrice");` },
	...
	},
	{
		...
		answerOptions: [
			...
			{ answer: `var siblingProductLinks = ServiceLocator.Current.GetInstance<IContentLoader>().GetDescendants(parentNodeLink)
							.where(c => ServiceLocator.Current.GetInstance<ReferenceConverter>()
							.GetContentType(c) == CatalogContentType.CatalogEntry)`,
				isCorrect: true,
			},
		],
		"isCode": true
